...
// Vercel Sandbox v3 accepts these special/private IPv4 CIDRs but currently
// rejects IPv6 CIDRs and returns a provider 500 for 240.0.0.0/4. Those omitted
// ranges remain blocked by the application URL/DNS guard before navigation.
